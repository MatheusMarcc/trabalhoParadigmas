...
var _CountriesResponseAllOf = _interopRequireDefault(require("./CountriesResponseAllOf"));
var _CountrySummary = _interopRequireDefault(require("./CountrySummary"));
  ...
  _createClass(CountriesResponse, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _CountriesResponseAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_CountrySummary["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _CountrySummary["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
// Implement CountriesResponseAllOf interface:
/**
 * @member {Array.<module:model/CountrySummary>} data
 */
_CountriesResponseAllOf["default"].prototype['data'] = undefined;
