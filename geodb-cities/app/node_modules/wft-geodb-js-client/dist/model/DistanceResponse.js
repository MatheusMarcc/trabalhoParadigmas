...
var _DistanceResponseAllOf = _interopRequireDefault(require("./DistanceResponseAllOf"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The DistanceResponse model module.
 * @module model/DistanceResponse
 * @version 2.0.3
 */
var DistanceResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DistanceResponse</code>.
   * A decimal distance (in miles or kilometers)
   * @alias module:model/DistanceResponse
   * @implements module:model/BaseResponse
   * @implements module:model/DistanceResponseAllOf
   */
  function DistanceResponse() {
    _classCallCheck(this, DistanceResponse);
    _BaseResponse["default"].initialize(this);
    _DistanceResponseAllOf["default"].initialize(this);
    DistanceResponse.initialize(this);
  }
   ...
   */
  _createClass(DistanceResponse, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>DistanceResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DistanceResponse} obj Optional instance to populate.
     * @return {module:model/DistanceResponse} The populated <code>DistanceResponse</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new DistanceResponse();
        _BaseResponse["default"].constructFromObject(data, obj);
        _DistanceResponseAllOf["default"].constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>DistanceResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DistanceResponse</code>.
     */
  }, {
    key: "validateJSON",
 ...
 */
DistanceResponse.prototype['errors'] = undefined;

/**
 * The distance in units as set by the distanceUnit param (defaults to miles)
 * @member {Number} data
 */
DistanceResponse.prototype['data'] = undefined;

// Implement BaseResponse interface:
/**
 * @member {Array.<module:model/Error>} errors
 */
_BaseResponse["default"].prototype['errors'] = undefined;
// Implement DistanceResponseAllOf interface:
/**
 * The distance in units as set by the distanceUnit param (defaults to miles)
 * @member {Number} data
 */
_DistanceResponseAllOf["default"].prototype['data'] = undefined;
var _default = DistanceResponse;
