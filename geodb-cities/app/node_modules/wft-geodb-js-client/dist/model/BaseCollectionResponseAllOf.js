...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The BaseCollectionResponseAllOf model module.
 * @module model/BaseCollectionResponseAllOf
 * @version 2.0.3
 */
var BaseCollectionResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BaseCollectionResponseAllOf</code>.
   * @alias module:model/BaseCollectionResponseAllOf
   */
  function BaseCollectionResponseAllOf() {
    _classCallCheck(this, BaseCollectionResponseAllOf);
    BaseCollectionResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(BaseCollectionResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>BaseCollectionResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseCollectionResponseAllOf} obj Optional instance to populate.
     * @return {module:model/BaseCollectionResponseAllOf} The populated <code>BaseCollectionResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BaseCollectionResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>BaseCollectionResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BaseCollectionResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
  ...
  return BaseCollectionResponseAllOf;
}();
/**
 * @member {Array.<module:model/Link>} links
 */
BaseCollectionResponseAllOf.prototype['links'] = undefined;

/**
 * @member {module:model/Metadata} metadata
 */
BaseCollectionResponseAllOf.prototype['metadata'] = undefined;
var _default = BaseCollectionResponseAllOf;
