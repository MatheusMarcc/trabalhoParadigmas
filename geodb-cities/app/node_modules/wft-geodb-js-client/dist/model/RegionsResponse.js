...
var _RegionSummary = _interopRequireDefault(require("./RegionSummary"));
var _RegionsResponseAllOf = _interopRequireDefault(require("./RegionsResponseAllOf"));
 ...
 * @version 2.0.3
 */
var RegionsResponse = /*#__PURE__*/function () {
  /**
   ...
   * @implements module:model/RegionsResponseAllOf
   */
  function RegionsResponse() {
    _classCallCheck(this, RegionsResponse);
    _BaseCollectionResponse["default"].initialize(this);
    _RegionsResponseAllOf["default"].initialize(this);
   ...
   */
  _createClass(RegionsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _RegionsResponseAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_RegionSummary["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _RegionSummary["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
// Implement RegionsResponseAllOf interface:
/**
 * A list of RegionSummaries
 * @member {Array.<module:model/RegionSummary>} data
 */
_RegionsResponseAllOf["default"].prototype['data'] = undefined;
var _default = RegionsResponse;
