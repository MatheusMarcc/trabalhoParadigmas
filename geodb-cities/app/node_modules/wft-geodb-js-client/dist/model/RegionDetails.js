 ...
 * @version 2.0.3
 */
var RegionDetails = /*#__PURE__*/function () {
  /**
  ...
  function RegionDetails() {
    _classCallCheck(this, RegionDetails);
   ...
   */
  _createClass(RegionDetails, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('capital')) {
          obj['capital'] = _ApiClient["default"].convertToType(data['capital'], 'String');
        }
        if (data.hasOwnProperty('countryCode')) {
          obj['countryCode'] = _ApiClient["default"].convertToType(data['countryCode'], 'String');
        }
        if (data.hasOwnProperty('fipsCode')) {
          obj['fipsCode'] = _ApiClient["default"].convertToType(data['fipsCode'], 'String');
        }
        ...
        if (data.hasOwnProperty('numCities')) {
          obj['numCities'] = _ApiClient["default"].convertToType(data['numCities'], 'Number');
        }
        if (data.hasOwnProperty('wikiDataId')) {
          obj['wikiDataId'] = _ApiClient["default"].convertToType(data['wikiDataId'], 'String');
        }
      }
      return obj;
    }
