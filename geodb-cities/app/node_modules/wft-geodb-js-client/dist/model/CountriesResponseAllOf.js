...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The CountriesResponseAllOf model module.
 * @module model/CountriesResponseAllOf
 * @version 2.0.3
 */
var CountriesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CountriesResponseAllOf</code>.
   * @alias module:model/CountriesResponseAllOf
   */
  function CountriesResponseAllOf() {
    _classCallCheck(this, CountriesResponseAllOf);
    CountriesResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(CountriesResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>CountriesResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CountriesResponseAllOf} obj Optional instance to populate.
     * @return {module:model/CountriesResponseAllOf} The populated <code>CountriesResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CountriesResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>CountriesResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CountriesResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _CountrySummary["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return CountriesResponseAllOf;
}();
/**
 * @member {Array.<module:model/CountrySummary>} data
 */
CountriesResponseAllOf.prototype['data'] = undefined;
var _default = CountriesResponseAllOf;
