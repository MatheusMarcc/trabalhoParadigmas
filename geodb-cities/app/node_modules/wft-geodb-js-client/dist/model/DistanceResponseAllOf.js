...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The DistanceResponseAllOf model module.
 * @module model/DistanceResponseAllOf
 * @version 2.0.3
 */
var DistanceResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DistanceResponseAllOf</code>.
   * @alias module:model/DistanceResponseAllOf
   */
  function DistanceResponseAllOf() {
    _classCallCheck(this, DistanceResponseAllOf);
    DistanceResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(DistanceResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>DistanceResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DistanceResponseAllOf} obj Optional instance to populate.
     * @return {module:model/DistanceResponseAllOf} The populated <code>DistanceResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new DistanceResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>DistanceResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DistanceResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
  ...
  return DistanceResponseAllOf;
}();
/**
 * The distance in units as set by the distanceUnit param (defaults to miles)
 * @member {Number} data
 */
DistanceResponseAllOf.prototype['data'] = undefined;
var _default = DistanceResponseAllOf;
