...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The TimeZoneResponseAllOf model module.
 * @module model/TimeZoneResponseAllOf
 * @version 2.0.3
 */
var TimeZoneResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TimeZoneResponseAllOf</code>.
   * @alias module:model/TimeZoneResponseAllOf
   */
  function TimeZoneResponseAllOf() {
    _classCallCheck(this, TimeZoneResponseAllOf);
    TimeZoneResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(TimeZoneResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>TimeZoneResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeZoneResponseAllOf} obj Optional instance to populate.
     * @return {module:model/TimeZoneResponseAllOf} The populated <code>TimeZoneResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TimeZoneResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeZoneResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeZoneResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
  ...
  return TimeZoneResponseAllOf;
}();
/**
 * The time-zone id
 * @member {String} id
 */
TimeZoneResponseAllOf.prototype['id'] = undefined;

/**
 * The time-zone name
 * @member {String} name
 */
TimeZoneResponseAllOf.prototype['name'] = undefined;

/**
 * The number of hours this time-zone is offset from UTC
 * @member {Number} rawUtcOffsetHours
 */
TimeZoneResponseAllOf.prototype['rawUtcOffsetHours'] = undefined;
var _default = TimeZoneResponseAllOf;
