...
var _LanguageDescriptor = _interopRequireDefault(require("./LanguageDescriptor"));
var _LanguagesResponseAllOf = _interopRequireDefault(require("./LanguagesResponseAllOf"));
  ...
  _createClass(LanguagesResponse, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _LanguagesResponseAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_LanguageDescriptor["default"]]);
        }
      }
      return obj;
    }
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _LanguageDescriptor["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
// Implement LanguagesResponseAllOf interface:
/**
 * @member {Array.<module:model/LanguageDescriptor>} data
 */
_LanguagesResponseAllOf["default"].prototype['data'] = undefined;
