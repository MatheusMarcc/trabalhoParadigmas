...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The LocalesResponseAllOf model module.
 * @module model/LocalesResponseAllOf
 * @version 2.0.3
 */
var LocalesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>LocalesResponseAllOf</code>.
   * @alias module:model/LocalesResponseAllOf
   */
  function LocalesResponseAllOf() {
    _classCallCheck(this, LocalesResponseAllOf);
    LocalesResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(LocalesResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>LocalesResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LocalesResponseAllOf} obj Optional instance to populate.
     * @return {module:model/LocalesResponseAllOf} The populated <code>LocalesResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new LocalesResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>LocalesResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LocalesResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _Locale["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return LocalesResponseAllOf;
}();
/**
 * @member {Array.<module:model/Locale>} data
 */
LocalesResponseAllOf.prototype['data'] = undefined;
var _default = LocalesResponseAllOf;
