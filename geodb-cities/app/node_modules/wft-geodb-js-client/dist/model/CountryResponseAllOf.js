...
var _CountryDetails = _interopRequireDefault(require("./CountryDetails"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The CountryResponseAllOf model module.
 * @module model/CountryResponseAllOf
 * @version 2.0.3
 */
var CountryResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>CountryResponseAllOf</code>.
   * @alias module:model/CountryResponseAllOf
   */
  function CountryResponseAllOf() {
    _classCallCheck(this, CountryResponseAllOf);
    CountryResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(CountryResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>CountryResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CountryResponseAllOf} obj Optional instance to populate.
     * @return {module:model/CountryResponseAllOf} The populated <code>CountryResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CountryResponseAllOf();
        if (data.hasOwnProperty('data')) {
          obj['data'] = _CountryDetails["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CountryResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CountryResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data['data']) {
        // data not null
        _CountryDetails["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
  return CountryResponseAllOf;
}();
/**
 * @member {module:model/CountryDetails} data
 */
CountryResponseAllOf.prototype['data'] = undefined;
var _default = CountryResponseAllOf;
