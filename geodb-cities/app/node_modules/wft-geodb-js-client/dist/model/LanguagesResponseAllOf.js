...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The LanguagesResponseAllOf model module.
 * @module model/LanguagesResponseAllOf
 * @version 2.0.3
 */
var LanguagesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>LanguagesResponseAllOf</code>.
   * @alias module:model/LanguagesResponseAllOf
   */
  function LanguagesResponseAllOf() {
    _classCallCheck(this, LanguagesResponseAllOf);
    LanguagesResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(LanguagesResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>LanguagesResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/LanguagesResponseAllOf} obj Optional instance to populate.
     * @return {module:model/LanguagesResponseAllOf} The populated <code>LanguagesResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new LanguagesResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>LanguagesResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LanguagesResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _LanguageDescriptor["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return LanguagesResponseAllOf;
}();
/**
 * @member {Array.<module:model/LanguageDescriptor>} data
 */
LanguagesResponseAllOf.prototype['data'] = undefined;
var _default = LanguagesResponseAllOf;
