...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The TimeZonesResponseAllOf model module.
 * @module model/TimeZonesResponseAllOf
 * @version 2.0.3
 */
var TimeZonesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>TimeZonesResponseAllOf</code>.
   * @alias module:model/TimeZonesResponseAllOf
   */
  function TimeZonesResponseAllOf() {
    _classCallCheck(this, TimeZonesResponseAllOf);
    TimeZonesResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(TimeZonesResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>TimeZonesResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TimeZonesResponseAllOf} obj Optional instance to populate.
     * @return {module:model/TimeZonesResponseAllOf} The populated <code>TimeZonesResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TimeZonesResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeZonesResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeZonesResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _TimeZoneDescriptor["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return TimeZonesResponseAllOf;
}();
/**
 * @member {Array.<module:model/TimeZoneDescriptor>} data
 */
TimeZonesResponseAllOf.prototype['data'] = undefined;
var _default = TimeZonesResponseAllOf;
