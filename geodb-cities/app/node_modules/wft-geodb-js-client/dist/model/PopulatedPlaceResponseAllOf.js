...
var _PopulatedPlaceDetails = _interopRequireDefault(require("./PopulatedPlaceDetails"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The PopulatedPlaceResponseAllOf model module.
 * @module model/PopulatedPlaceResponseAllOf
 * @version 2.0.3
 */
var PopulatedPlaceResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PopulatedPlaceResponseAllOf</code>.
   * @alias module:model/PopulatedPlaceResponseAllOf
   */
  function PopulatedPlaceResponseAllOf() {
    _classCallCheck(this, PopulatedPlaceResponseAllOf);
    PopulatedPlaceResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(PopulatedPlaceResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>PopulatedPlaceResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PopulatedPlaceResponseAllOf} obj Optional instance to populate.
     * @return {module:model/PopulatedPlaceResponseAllOf} The populated <code>PopulatedPlaceResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PopulatedPlaceResponseAllOf();
        if (data.hasOwnProperty('data')) {
          obj['data'] = _PopulatedPlaceDetails["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PopulatedPlaceResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PopulatedPlaceResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data['data']) {
        // data not null
        _PopulatedPlaceDetails["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
  return PopulatedPlaceResponseAllOf;
}();
/**
 * @member {module:model/PopulatedPlaceDetails} data
 */
PopulatedPlaceResponseAllOf.prototype['data'] = undefined;
var _default = PopulatedPlaceResponseAllOf;
