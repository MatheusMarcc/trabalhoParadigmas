...
var _PopulatedPlaceSummary = _interopRequireDefault(require("./PopulatedPlaceSummary"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The PopulatedPlacesResponseAllOf model module.
 * @module model/PopulatedPlacesResponseAllOf
 * @version 2.0.3
 */
var PopulatedPlacesResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PopulatedPlacesResponseAllOf</code>.
   * @alias module:model/PopulatedPlacesResponseAllOf
   */
  function PopulatedPlacesResponseAllOf() {
    _classCallCheck(this, PopulatedPlacesResponseAllOf);
    PopulatedPlacesResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(PopulatedPlacesResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>PopulatedPlacesResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PopulatedPlacesResponseAllOf} obj Optional instance to populate.
     * @return {module:model/PopulatedPlacesResponseAllOf} The populated <code>PopulatedPlacesResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PopulatedPlacesResponseAllOf();
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ApiClient["default"].convertToType(data['data'], [_PopulatedPlaceSummary["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PopulatedPlacesResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PopulatedPlacesResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _PopulatedPlaceSummary["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return PopulatedPlacesResponseAllOf;
}();
/**
 * @member {Array.<module:model/PopulatedPlaceSummary>} data
 */
PopulatedPlacesResponseAllOf.prototype['data'] = undefined;
var _default = PopulatedPlacesResponseAllOf;
