...
var _BaseCollectionResponseAllOf = _interopRequireDefault(require("./BaseCollectionResponseAllOf"));
 ...
 * @version 2.0.3
 */
var BaseCollectionResponse = /*#__PURE__*/function () {
  /**
   ...
   * @implements module:model/BaseCollectionResponseAllOf
   */
  function BaseCollectionResponse() {
    _classCallCheck(this, BaseCollectionResponse);
    _BaseResponse["default"].initialize(this);
    _BaseCollectionResponseAllOf["default"].initialize(this);
   ...
   */
  _createClass(BaseCollectionResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _BaseCollectionResponseAllOf["default"].constructFromObject(data, obj);
...
// Implement BaseCollectionResponseAllOf interface:
/**
 * @member {Array.<module:model/Link>} links
 */
_BaseCollectionResponseAllOf["default"].prototype['links'] = undefined;
/**
 * @member {module:model/Metadata} metadata
 */
_BaseCollectionResponseAllOf["default"].prototype['metadata'] = undefined;
var _default = BaseCollectionResponse;
