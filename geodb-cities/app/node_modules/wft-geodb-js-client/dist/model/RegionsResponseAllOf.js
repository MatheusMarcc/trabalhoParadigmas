...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The RegionsResponseAllOf model module.
 * @module model/RegionsResponseAllOf
 * @version 2.0.3
 */
var RegionsResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RegionsResponseAllOf</code>.
   * @alias module:model/RegionsResponseAllOf
   */
  function RegionsResponseAllOf() {
    _classCallCheck(this, RegionsResponseAllOf);
    RegionsResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(RegionsResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>RegionsResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegionsResponseAllOf} obj Optional instance to populate.
     * @return {module:model/RegionsResponseAllOf} The populated <code>RegionsResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new RegionsResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>RegionsResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegionsResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            _RegionSummary["default"].validateJSON(item);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
  ...
  return RegionsResponseAllOf;
}();
/**
 * A list of RegionSummaries
 * @member {Array.<module:model/RegionSummary>} data
 */
RegionsResponseAllOf.prototype['data'] = undefined;
var _default = RegionsResponseAllOf;
