...
var _RegionDetails = _interopRequireDefault(require("./RegionDetails"));
...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The RegionResponseAllOf model module.
 * @module model/RegionResponseAllOf
 * @version 2.0.3
 */
var RegionResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RegionResponseAllOf</code>.
   * @alias module:model/RegionResponseAllOf
   */
  function RegionResponseAllOf() {
    _classCallCheck(this, RegionResponseAllOf);
    RegionResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(RegionResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>RegionResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RegionResponseAllOf} obj Optional instance to populate.
     * @return {module:model/RegionResponseAllOf} The populated <code>RegionResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new RegionResponseAllOf();
        if (data.hasOwnProperty('data')) {
          obj['data'] = _RegionDetails["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>RegionResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RegionResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data['data']) {
        // data not null
        _RegionDetails["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
  return RegionResponseAllOf;
}();
/**
 * @member {module:model/RegionDetails} data
 */
RegionResponseAllOf.prototype['data'] = undefined;
var _default = RegionResponseAllOf;
