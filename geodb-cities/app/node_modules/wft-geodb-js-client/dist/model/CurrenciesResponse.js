...
var _CurrenciesResponseAllOf = _interopRequireDefault(require("./CurrenciesResponseAllOf"));
 ...
 * @version 2.0.3
 */
var CurrenciesResponse = /*#__PURE__*/function () {
  /**
   ...
   * @implements module:model/CurrenciesResponseAllOf
   */
  function CurrenciesResponse() {
    _classCallCheck(this, CurrenciesResponse);
    _BaseCollectionResponse["default"].initialize(this);
    _CurrenciesResponseAllOf["default"].initialize(this);
   ...
   */
  _createClass(CurrenciesResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _CurrenciesResponseAllOf["default"].constructFromObject(data, obj);
      ...
      if (data['data']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _Currency["default"].validateJSON(_item2);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
 ...
 */
CurrenciesResponse.prototype['errors'] = undefined;
 ...
 */
CurrenciesResponse.prototype['metadata'] = undefined;
...
// Implement CurrenciesResponseAllOf interface:
/**
 * @member {Array.<module:model/Currency>} data
 */
_CurrenciesResponseAllOf["default"].prototype['data'] = undefined;
var _default = CurrenciesResponse;
