 ...
 * @version 2.0.3
 */
var CountrySummary = /*#__PURE__*/function () {
  /**
  ...
  function CountrySummary() {
    _classCallCheck(this, CountrySummary);
   ...
   */
  _createClass(CountrySummary, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('currencyCodes')) {
          obj['currencyCodes'] = _ApiClient["default"].convertToType(data['currencyCodes'], ['String']);
        }
