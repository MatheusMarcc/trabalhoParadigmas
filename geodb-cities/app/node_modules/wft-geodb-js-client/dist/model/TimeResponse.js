...
var _TimeResponseAllOf = _interopRequireDefault(require("./TimeResponseAllOf"));
...
var TimeResponse = /*#__PURE__*/function () {
   ...
   */
  _createClass(TimeResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TimeResponse();
        _BaseResponse["default"].constructFromObject(data, obj);
        _TimeResponseAllOf["default"].constructFromObject(data, obj);
    ...
    /**
     * Validates the JSON data with respect to <code>TimeResponse</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeResponse</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      ...
      if (data['data'] && !(typeof data['data'] === 'string' || data['data'] instanceof String)) {
        throw new _Error["default"]("Expected the field `data` to be a primitive type in the JSON string but got " + data['data']);
      }
      return true;
    }
  }]);
 ...
 */
TimeResponse.prototype['errors'] = undefined;

/**
 * The time in ISO-8601 format: HHmmss.SSSZ
 * @member {String} data
 */
TimeResponse.prototype['data'] = undefined;
...
// Implement TimeResponseAllOf interface:
/**
 * The time in ISO-8601 format: HHmmss.SSSZ
 * @member {String} data
 */
_TimeResponseAllOf["default"].prototype['data'] = undefined;
var _default = TimeResponse;
