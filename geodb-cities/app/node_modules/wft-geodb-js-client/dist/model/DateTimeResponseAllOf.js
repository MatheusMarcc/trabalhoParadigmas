...
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); } /**
                                                                                                                                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                                                                                                                                               */
/**
 * The DateTimeResponseAllOf model module.
 * @module model/DateTimeResponseAllOf
 * @version 2.0.3
 */
var DateTimeResponseAllOf = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DateTimeResponseAllOf</code>.
   * @alias module:model/DateTimeResponseAllOf
   */
  function DateTimeResponseAllOf() {
    _classCallCheck(this, DateTimeResponseAllOf);
    DateTimeResponseAllOf.initialize(this);
  }
   ...
   */
  _createClass(DateTimeResponseAllOf, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>DateTimeResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DateTimeResponseAllOf} obj Optional instance to populate.
     * @return {module:model/DateTimeResponseAllOf} The populated <code>DateTimeResponseAllOf</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new DateTimeResponseAllOf();
    ...
    /**
     * Validates the JSON data with respect to <code>DateTimeResponseAllOf</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DateTimeResponseAllOf</code>.
     */
  }, {
    key: "validateJSON",
  ...
  return DateTimeResponseAllOf;
}();
/**
 * The date-time in ISO-6801 format: yyyyMMdd'T'HHmmssZ
 * @member {String} data
 */
DateTimeResponseAllOf.prototype['data'] = undefined;
var _default = DateTimeResponseAllOf;
